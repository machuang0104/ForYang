 ...
 */
package com.ma.text.broadcast.receiver.netstate;
...
import com.ma.text.broadcast.receiver.netstate.NetWorkUtil.NetType;

/**
 * @Description:检测网络状态改变 需要配置 <receiver
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (intent.getAction().equalsIgnoreCase(ANDROID_NET_CHANGE_ACTION)
			...
			if (!NetWorkUtil.isNetworkAvailable(context)) {
				...
				App.isNetWork = networkAvailable;
