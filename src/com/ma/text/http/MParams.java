...
public class MParams {
	...
	public void addParamBody(String name, String value) {
		if (bodyParams == null) {
	...
	public String toString() {
		return " Params [charset=" + charset + ", headers=" + headers
				+ ", params=" + params + ", bodyEntity=" + bodyEntity
				+ ", bodyParams=" + bodyParams + ", fileParams=" + fileParams
				+ "]";
	}
