...
import com.ma.text.db.util.sql.DeleteSqlBuilder;
import com.ma.text.db.util.sql.InsertSqlBuilder;
import com.ma.text.db.util.sql.QuerySqlBuilder;
import com.ma.text.db.util.sql.ReplaceIntoSqlBuilder;
import com.ma.text.db.util.sql.SqlBuilder;
import com.ma.text.db.util.sql.UpdateSqlBuilder;
