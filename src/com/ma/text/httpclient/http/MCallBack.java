...
public abstract class MCallBack<T> {
	...
	public MCallBack(int rate) {
		this.rate = rate;
	}

	public MCallBack(Object userTag) {
		this.rate = DEFAULT_RATE;
		this.userTag = userTag;
	}

	public MCallBack(int rate, Object userTag) {
		this.rate = rate;
		this.userTag = userTag;
	}
	...
	public abstract void onSuccess(Response<T> res);

	public abstract void onFailure(HttpException e, String msg);
}
