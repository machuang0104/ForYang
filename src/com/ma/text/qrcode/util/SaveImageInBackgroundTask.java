package com.ma.text.qrcode.util;
		...
		mNotificationBuilder = new Notification.Builder(context)
				.setTicker(
						r.getString(R.string.screenshot_saving_ticker)
								+ (mTickerAddSpace ? " " : ""))
				.setContentTitle(r.getString(R.string.screenshot_saving_ticker))
				.setContentText(r.getString(R.string.screenshot_saving_ticker))
