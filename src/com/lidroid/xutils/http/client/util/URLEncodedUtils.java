...
public class URLEncodedUtils {
	...
	/**
	 * Characters which are safe to use in a fragment, i.e. {@link #RESERVED} plus
	 * {@link #UNRESERVED}
	 */
	 ...
	 * and browser behaviour, i.e. alphanumeric plus {@code "-", "_", ".", "*"}
	 */
...
//	}
	...
	// * @return encoded string
	// */
	// private static String decodeFormFields(final String content, final String
	// charset) {
	// if (content == null) {
	// return null;
	// }
	...
	// * @return encoded string
	// */
	// private static String decodeFormFields(final String content, final Charset
	// charset) {
	// if (content == null) {
	// return null;
	// }
	// return urldecode(content, charset != null ? charset :
	// Charset.forName(HTTP.UTF_8), true);
	// }
	...
	private static String encodeFormFields(final String content,
		...
		return urlencode(content, charset != null
	...
	private static String encodeFormFields(final String content,
		...
		return urlencode(content,
				charset != null ? charset : Charset.forName(HTTP.UTF_8), URLENCODER,
				true);
	}
