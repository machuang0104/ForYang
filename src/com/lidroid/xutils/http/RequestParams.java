...
public class RequestParams {
	...
	public String toString() {
		return "RequestParams [charset=" + charset + ", headers=" + headers
				+ ", queryStringParams=" + queryStringParams + ", bodyEntity="
				+ bodyEntity + ", bodyParams=" + bodyParams + ", fileParams="
				+ fileParams + ", priority=" + priority + "]";
	}
